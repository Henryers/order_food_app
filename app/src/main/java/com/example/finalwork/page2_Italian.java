...
public class page2_Italian extends AppCompatActivity {
    ...
    private String[] foodnames = {
            "经典意大利面","西冷牛排","战斧牛排","榴莲披萨","小吃拼盘","奶香菌菇汤","金桔柠檬汁"
    };
    private String[] foodprices = {
            "28","68","88","43","39","12","18"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_italian);

        //返回键
        TextView back = findViewById(R.id.italian_back);
        //名称
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(page2_Italian.this,"您点击了"+foodname+",",Toast.LENGTH_SHORT).show();
        ...
        toCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        if (quantity !=0) {
                            ...
                            Intent to_p3cart = new Intent(page2_Italian.this, page3_Cart.class);
                ...
                Intent to_p3 = new Intent(page2_Italian.this, page3.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back_p2 = new Intent(page2_Italian.this,page2.class);
