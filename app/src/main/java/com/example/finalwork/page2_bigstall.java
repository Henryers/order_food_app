...
public class page2_bigstall extends AppCompatActivity {
    ...
    //map里面的img数组
    private int[] imgs = {
            R.drawable.bigstall1,
            R.drawable.bigstall2,
            R.drawable.bigstall3,
            R.drawable.bigstall4,
            R.drawable.bigstall5,
            R.drawable.bigstall6,
            R.drawable.bigstall7,
            R.drawable.bigstall8
    };
    private String[] foodnames = {
            "北京烤鸭","清蒸草鱼","炭烧猪颈肉","墨斗丸子汤","香辣小龙虾","浓甜糍粑","牛肉炒芥兰","青岛啤酒"
    };
    private String[] foodprices = {
            "88","79","58","42","108","28","34","12"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_bigstall);

        //返回键
        TextView back = findViewById(R.id.bigstall_back);
        //名称
        ...
        mSimpleAdapter = new SimpleAdapter(this,           //上下文对象
                mList,R.layout.activity_page2_bigstall1,          //自己写的列表，传到对应的item_xml的文件,注意是item 不是list
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(page2_bigstall.this,"您点击了"+foodname+",",Toast.LENGTH_SHORT).show();
        ...
        toCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        if (quantity !=0) {
                            ...
                            Intent to_p3cart = new Intent(page2_bigstall.this, page3_Cart.class);
                ...
                Intent to_p3 = new Intent(page2_bigstall.this, page3.class);
                startActivity(to_p3);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back_p2 = new Intent(page2_bigstall.this,page2.class);
