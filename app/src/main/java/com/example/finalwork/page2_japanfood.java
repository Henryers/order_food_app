...
public class page2_japanfood extends AppCompatActivity {
    ...
    //map里面的img数组
    private int[] imgs = {
            R.drawable.japanfood1,
            R.drawable.japanfood2,
            R.drawable.japanfood3,
            R.drawable.japanfood4,
            R.drawable.japanfood5,
            R.drawable.japanfood6,
            R.drawable.japanfood7
    };
    private String[] foodnames = {
            "蟹柳寿司","紫菜卷饭","丰富自选寿司","鳗鱼饭","刺身三文鱼","经典日式盖饭","豚骨拉面"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_japanfood);

        //返回键
        TextView back = findViewById(R.id.japanfood_back);
        //名称
        ...
        mSimpleAdapter = new SimpleAdapter(this,           //上下文对象
                mList,R.layout.activity_page2_italian1,           //自己写的列表，传到对应的item_xml的文件,注意是item 不是list
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(page2_japanfood.this,"您点击了"+foodname+",",Toast.LENGTH_SHORT).show();
        ...
        toCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        if (quantity !=0) {
                            ...
                            Intent to_p3cart = new Intent(page2_japanfood.this, page3_Cart.class);
                ...
                Intent to_p3 = new Intent(page2_japanfood.this, page3.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back_p2 = new Intent(page2_japanfood.this,page2.class);
