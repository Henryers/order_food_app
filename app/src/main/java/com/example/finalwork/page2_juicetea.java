...
public class page2_juicetea extends AppCompatActivity {
    ...
    //map里面的img数组
    private int[] imgs = {
            R.drawable.juicetea1,
            R.drawable.juicetea2,
            R.drawable.juicetea3,
            R.drawable.juicetea4,
            R.drawable.juicetea5,
            R.drawable.juicetea6,
            R.drawable.juicetea7
    };
    private String[] foodnames = {
            "人气芒芒","草莓芝士奶盖","果茶全家桶","多肉葡萄","椰椰乌龙","珍珠奶茶","美式热狗"
    };
    private String[] foodprices = {
            "23","25","29","21","19","13","16"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_juicetea);

        //返回键
        TextView back = findViewById(R.id.juicetea_back);
        //名称
        ...
        mSimpleAdapter = new SimpleAdapter(this,           //上下文对象
                mList,R.layout.activity_page2_juicetea1,           //自己写的列表，传到对应的item_xml的文件,注意是item 不是list
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(page2_juicetea.this,"您点击了"+foodname+",",Toast.LENGTH_SHORT).show();
        ...
        toCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        if (quantity !=0) {
                            ...
                            Intent to_p3cart = new Intent(page2_juicetea.this, page3_Cart.class);
                ...
                Intent to_p3 = new Intent(page2_juicetea.this, page3.class);
                startActivity(to_p3);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back_p2 = new Intent(page2_juicetea.this,page2.class);
