...
public class page2_midfood extends AppCompatActivity {
    ...
    private String[] foodnames = {
            "土豆焖鸡肉","梅菜扣肉","酱香土豆丝","农家小炒肉","东北锅包肉","番茄炒蛋","糖醋里脊","耗油生菜"
    };
    private String[] foodprices = {
            "48","58","24","33","69","22","38","18"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_midfood);

        //返回键
        TextView back = findViewById(R.id.midfood_back);
        //名称
        ...
        mSimpleAdapter = new SimpleAdapter(this,           //上下文对象
                mList,R.layout.activity_page2_midfood1,           //自己写的列表，传到对应的item_xml的文件,注意是item 不是list
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(page2_midfood.this,"您点击了"+foodname+",",Toast.LENGTH_SHORT).show();
        ...
        toCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        if (quantity !=0) {
                            ...
                            Intent to_p3cart = new Intent(page2_midfood.this, page3_Cart.class);
                ...
                Intent to_p3 = new Intent(page2_midfood.this, page3.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back_p2 = new Intent(page2_midfood.this,page2.class);
