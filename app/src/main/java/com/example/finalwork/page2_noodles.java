...
public class page2_noodles extends AppCompatActivity {
    ...
    private String[] foodnames = {
            "招牌刀削面","经典兰州拉面","番茄鸡蛋面","牛肉炒粿条","东北水饺","紫菜肉沫汤","哈尔滨啤酒"
    };
    private String[] foodprices = {
            "33","28","23","35","19","18","11"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_noodles);

        //返回键
        TextView back = findViewById(R.id.noodles_back);
        //名称
        ...
        mSimpleAdapter = new SimpleAdapter(this,           //上下文对象
                mList,R.layout.activity_page2_noodles1,           //自己写的列表，传到对应的item_xml的文件,注意是item 不是list
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(page2_noodles.this,"您点击了"+foodname+",",Toast.LENGTH_SHORT).show();
        ...
        toCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        if (quantity !=0) {
                            ...
                            Intent to_p3cart = new Intent(page2_noodles.this, page3_Cart.class);
                ...
                Intent to_p3 = new Intent(page2_noodles.this, page3.class);
                startActivity(to_p3);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back_p2 = new Intent(page2_noodles.this,page2.class);
