...
public class page2_northwest extends AppCompatActivity {
    ...
    //map里面的img数组
    private int[] imgs = {
            R.drawable.northwest1,
            R.drawable.northwest2,
            R.drawable.northwest3,
            R.drawable.northwest4,
            R.drawable.northwest5,
            R.drawable.northwest6,
            R.drawable.northwest7,
            R.drawable.northwest8
    };
    private String[] foodnames = {
            "经典肉夹馍","陕西凉皮","biangbiang面","酱大骨","炸酱面","手工猪肉饺子","葱油拌面","酸菜牛肉面"
    };
    private String[] foodprices = {
            "28","19","28","34","17","22","18","21"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_northwest);

        //返回键
        TextView back = findViewById(R.id.northwest_back);
        //名称
        ...
        mSimpleAdapter = new SimpleAdapter(this,           //上下文对象
                mList,R.layout.activity_page2_northwest1,         //自己写的列表，传到对应的item_xml的文件,注意是item 不是list
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(page2_northwest.this,"您点击了"+foodname+",",Toast.LENGTH_SHORT).show();
        ...
        toCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        if (quantity !=0) {
                            ...
                            Intent to_p3cart = new Intent(page2_northwest.this, page3_Cart.class);
                ...
                Intent to_p3 = new Intent(page2_northwest.this, page3.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back_p2 = new Intent(page2_northwest.this,page2.class);
