...
public class page2_pizza extends AppCompatActivity {
    ...
    private String[] foodnames = {
            "双层芝士披萨","榴莲披萨","畅销奶黄披萨","奥尔良披萨","葡式蛋挞","芝士爆浆鸡排","鸡翅包饭","美味薯条"
    };
    private String[] foodprices = {
            "78","68","58","88","9","32","18","11"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_pizza);

        //返回键
        TextView back = findViewById(R.id.pizza_back);
        //名称
        ...
        mSimpleAdapter = new SimpleAdapter(this,           //上下文对象
                mList,R.layout.activity_page2_pizza1,             //自己写的列表，传到对应的item_xml的文件,注意是item 不是list
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(page2_pizza.this,"您点击了"+foodname+",",Toast.LENGTH_SHORT).show();
        ...
        toCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        if (quantity !=0) {
                            ...
                            Intent to_p3cart = new Intent(page2_pizza.this, page3_Cart.class);
                ...
                Intent to_p3 = new Intent(page2_pizza.this, page3.class);
                startActivity(to_p3);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back_p2 = new Intent(page2_pizza.this,page2.class);
