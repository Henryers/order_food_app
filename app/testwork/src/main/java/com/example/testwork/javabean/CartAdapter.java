package com.example.testwork.javabean;
...
import com.example.testwork.zMysqlFoodHelper;
...
public class CartAdapter extends ArrayAdapter<Product> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageButton increaseButton = convertView.findViewById(R.id.increase_button);
        ImageButton decreaseButton = convertView.findViewById(R.id.decrease_button);
